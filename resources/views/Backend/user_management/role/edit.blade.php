...
@section('content')
    ...
    <!-- Start Page Content -->
    <!-- ============================================================== -->
    @include('Backend.layouts.partials.breadcumb',['data' => ['Roles','edit'],'button'=>['display' => false]])
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-md-10 offset-md-1">
                        ...
                        <form class="m-t-20" method="POST" action="{{route('role.update', $role->id)}}"  novalidate autocomplete="off">
                            @csrf @method('patch')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group  ">
                                        ...
                                        <div class="controls ">
                                            <input type="text" name="name" value="{{ old('name')??$role->name }}" class="form-control" required data-validation-required-message="Name is required" autofocus> 
                                        </div>
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-12">
                                                                    <span class="icheck-list " style="width:100%">
                                                                        <p class="zoomer" style="width:100%">
                                                                            <input type="checkbox" {{ $checked }} name="permission[]" class="check" id="chk-{{$k}}" value="{{ $permission->id }}" data-checkbox="icheckbox_line-red" data-label="{{$permission->name}}" >
